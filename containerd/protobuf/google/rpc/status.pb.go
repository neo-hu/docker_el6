...
// source: github.com/neo-hu/docker_el6/containerd/protobuf/google/rpc/status.proto
...
func init() {
	proto.RegisterFile("github.com/neo-hu/docker_el6/containerd/protobuf/google/rpc/status.proto", fileDescriptorStatus)
}
