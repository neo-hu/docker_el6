...
import (
	...
	"github.com/neo-hu/docker_el6/containerd/api/services/containers/v1"
	contentapi "github.com/neo-hu/docker_el6/containerd/api/services/content/v1"
	"github.com/neo-hu/docker_el6/containerd/api/services/diff/v1"
	eventsapi "github.com/neo-hu/docker_el6/containerd/api/services/events/v1"
	"github.com/neo-hu/docker_el6/containerd/api/services/images/v1"
	"github.com/neo-hu/docker_el6/containerd/api/services/introspection/v1"
	leasesapi "github.com/neo-hu/docker_el6/containerd/api/services/leases/v1"
	"github.com/neo-hu/docker_el6/containerd/api/services/namespaces/v1"
	...
	"github.com/neo-hu/docker_el6/containerd/api/services/version/v1"
	"github.com/neo-hu/docker_el6/containerd/content"
	"github.com/neo-hu/docker_el6/containerd/content/local"
	"github.com/neo-hu/docker_el6/containerd/events/exchange"
	...
	"github.com/neo-hu/docker_el6/go-metrics"
...
func interceptor(
	...
	if info.FullMethod != "/grpc.health.v1.Health/Check" {
		log.G(ctx).Debugf("call %s", info.FullMethod)
	}
