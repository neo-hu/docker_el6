...
// source: github.com/neo-hu/docker_el6/containerd/api/events/task.proto
...
func init() {
	proto.RegisterFile("github.com/neo-hu/docker_el6/containerd/api/events/task.proto", fileDescriptorTask)
}
