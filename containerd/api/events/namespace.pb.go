...
// source: github.com/neo-hu/docker_el6/containerd/api/events/namespace.proto
...
func init() {
	proto.RegisterFile("github.com/neo-hu/docker_el6/containerd/api/events/namespace.proto", fileDescriptorNamespace)
}
