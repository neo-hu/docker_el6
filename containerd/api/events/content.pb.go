...
// source: github.com/neo-hu/docker_el6/containerd/api/events/content.proto
...
func init() {
	proto.RegisterFile("github.com/neo-hu/docker_el6/containerd/api/events/content.proto", fileDescriptorContent)
}
