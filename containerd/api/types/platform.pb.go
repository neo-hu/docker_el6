...
// source: github.com/neo-hu/docker_el6/containerd/api/types/platform.proto
...
func init() {
	proto.RegisterFile("github.com/neo-hu/docker_el6/containerd/api/types/platform.proto", fileDescriptorPlatform)
}
