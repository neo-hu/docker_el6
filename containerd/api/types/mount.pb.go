...
// source: github.com/neo-hu/docker_el6/containerd/api/types/mount.proto
...
func init() {
	proto.RegisterFile("github.com/neo-hu/docker_el6/containerd/api/types/mount.proto", fileDescriptorMount)
}
