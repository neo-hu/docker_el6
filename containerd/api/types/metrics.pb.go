...
// source: github.com/neo-hu/docker_el6/containerd/api/types/metrics.proto
...
func init() {
	proto.RegisterFile("github.com/neo-hu/docker_el6/containerd/api/types/metrics.proto", fileDescriptorMetrics)
}
