...
import (
	...
	"github.com/neo-hu/docker_el6/go-events"
	gmetrics "github.com/neo-hu/docker_el6/go-metrics"
	"github.com/neo-hu/docker_el6/docker/swarmkit/api"
	"github.com/neo-hu/docker_el6/docker/swarmkit/ca"
	"github.com/neo-hu/docker_el6/docker/swarmkit/ca/keyutils"
	"github.com/neo-hu/docker_el6/docker/swarmkit/connectionbroker"
	"github.com/neo-hu/docker_el6/docker/swarmkit/identity"
	"github.com/neo-hu/docker_el6/docker/swarmkit/log"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/allocator"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/allocator/networkallocator"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/controlapi"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/dispatcher"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/drivers"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/health"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/keymanager"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/logbroker"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/metrics"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/orchestrator/constraintenforcer"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/orchestrator/global"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/orchestrator/replicated"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/orchestrator/taskreaper"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/resourceapi"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/scheduler"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/state/raft"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/state/raft/transport"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/state/store"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/watchapi"
	"github.com/neo-hu/docker_el6/docker/swarmkit/remotes"
	"github.com/neo-hu/docker_el6/docker/swarmkit/xnet"
