...
import (
	...
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/raftselector"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/state"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/state/raft/membership"
	"github.com/neo-hu/docker_el6/docker/swarmkit/manager/state/raft/storage"
	...
	"github.com/neo-hu/docker_el6/docker/swarmkit/watch"
...
func (n *Node) ProcessRaftMessage(ctx context.Context, msg *api.ProcessRaftMessageRequest) (*api.ProcessRaftMessageResponse, error) {
	...
	// See https://github.com/neo-hu/docker_el6/docker/issues/30455.
