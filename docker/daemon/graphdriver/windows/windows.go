...
import (
	...
	"github.com/neo-hu/docker_el6/docker/pkg/longpath"
	"github.com/neo-hu/docker_el6/docker/pkg/reexec"
	...
	if noreexec {
		defer func() {
			if err := winio.DisableProcessPrivileges([]string{winio.SeBackupPrivilege, winio.SeRestorePrivilege}); err != nil {
				...
				// See https://github.com/neo-hu/docker_el6/docker/pull/28002#discussion_r86259241 for rationale.
