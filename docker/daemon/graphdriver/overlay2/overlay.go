...
import (
	...
	"github.com/neo-hu/docker_el6/docker/daemon/graphdriver"
	"github.com/neo-hu/docker_el6/docker/daemon/graphdriver/overlayutils"
	"github.com/neo-hu/docker_el6/docker/daemon/graphdriver/quota"
	"github.com/neo-hu/docker_el6/docker/pkg/archive"
	"github.com/neo-hu/docker_el6/docker/pkg/chrootarchive"
	"github.com/neo-hu/docker_el6/docker/pkg/containerfs"
	"github.com/neo-hu/docker_el6/docker/pkg/directory"
	"github.com/neo-hu/docker_el6/docker/pkg/fsutils"
	...
	"github.com/neo-hu/docker_el6/go-units"
...
func (d *Driver) Get(id, mountLabel string) (_ containerfs.ContainerFS, retErr error) {
	...
	// See https://github.com/neo-hu/docker_el6/docker/issues/27384
	if pageSize > 4096 {
		pageSize = 4096
	}
