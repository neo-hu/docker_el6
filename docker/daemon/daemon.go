...
import (
	...
	"github.com/neo-hu/docker_el6/docker/daemon/discovery"
	"github.com/neo-hu/docker_el6/docker/daemon/events"
	"github.com/neo-hu/docker_el6/docker/daemon/exec"
	"github.com/neo-hu/docker_el6/docker/daemon/logger"
	"github.com/neo-hu/docker_el6/docker/daemon/network"
	"github.com/neo-hu/docker_el6/docker/errdefs"
	"github.com/sirupsen/logrus"
	// register graph drivers
	_ "github.com/neo-hu/docker_el6/docker/daemon/graphdriver/register"
	"github.com/neo-hu/docker_el6/docker/daemon/stats"
	dmetadata "github.com/neo-hu/docker_el6/docker/distribution/metadata"
	"github.com/neo-hu/docker_el6/docker/distribution/xfer"
	...
	"github.com/neo-hu/docker_el6/docker/migrate/v1"
	"github.com/neo-hu/docker_el6/docker/pkg/idtools"
	"github.com/neo-hu/docker_el6/docker/pkg/locker"
	...
	"github.com/neo-hu/docker_el6/docker/pkg/truncindex"
	"github.com/neo-hu/docker_el6/docker/plugin"
	pluginexec "github.com/neo-hu/docker_el6/docker/plugin/executor/containerd"
	refstore "github.com/neo-hu/docker_el6/docker/reference"
	"github.com/neo-hu/docker_el6/docker/registry"
	"github.com/neo-hu/docker_el6/docker/runconfig"
	volumedrivers "github.com/neo-hu/docker_el6/docker/volume/drivers"
	"github.com/neo-hu/docker_el6/docker/volume/local"
	"github.com/neo-hu/docker_el6/docker/volume/store"
	"github.com/neo-hu/docker_el6/libnetwork"
	"github.com/neo-hu/docker_el6/libnetwork/cluster"
	nwconfig "github.com/neo-hu/docker_el6/libnetwork/config"
	"github.com/neo-hu/docker_el6/libtrust"
...
func (daemon *Daemon) restore() error {
	...
	for id, c := range containers {
		...
		// Fixes https://github.com/neo-hu/docker_el6/docker/issues/22536
