...
import (
	...
	"github.com/neo-hu/docker_el6/distribution/manifest/manifestlist"
	"github.com/neo-hu/docker_el6/distribution/manifest/schema1"
	"github.com/neo-hu/docker_el6/distribution/manifest/schema2"
	"github.com/neo-hu/docker_el6/distribution/reference"
	"github.com/neo-hu/docker_el6/distribution/registry/api/errcode"
	"github.com/neo-hu/docker_el6/distribution/registry/client/auth"
	"github.com/neo-hu/docker_el6/distribution/registry/client/transport"
	"github.com/neo-hu/docker_el6/docker/distribution/metadata"
	"github.com/neo-hu/docker_el6/docker/distribution/xfer"
	"github.com/neo-hu/docker_el6/docker/image"
	"github.com/neo-hu/docker_el6/docker/image/v1"
	"github.com/neo-hu/docker_el6/docker/layer"
	"github.com/neo-hu/docker_el6/docker/pkg/ioutils"
	"github.com/neo-hu/docker_el6/docker/pkg/progress"
...
func (p *v2Puller) pullSchema2(ctx context.Context, ref reference.Named, mfst *schema2.DeserializedManifest, requestedOS string) (id digest.Digest, manifestDigest digest.Digest, err error) {
	...
	// https://github.com/neo-hu/docker_el6/docker/issues/24766 - Err on the side of caution,
