...
import (
	...
	containersapi "github.com/neo-hu/docker_el6/containerd/api/services/containers/v1"
	contentapi "github.com/neo-hu/docker_el6/containerd/api/services/content/v1"
	diffapi "github.com/neo-hu/docker_el6/containerd/api/services/diff/v1"
	eventsapi "github.com/neo-hu/docker_el6/containerd/api/services/events/v1"
	imagesapi "github.com/neo-hu/docker_el6/containerd/api/services/images/v1"
	introspectionapi "github.com/neo-hu/docker_el6/containerd/api/services/introspection/v1"
	namespacesapi "github.com/neo-hu/docker_el6/containerd/api/services/namespaces/v1"
	snapshotsapi "github.com/neo-hu/docker_el6/containerd/api/services/snapshots/v1"
	"github.com/neo-hu/docker_el6/containerd/api/services/tasks/v1"
	versionservice "github.com/neo-hu/docker_el6/containerd/api/services/version/v1"
	"github.com/neo-hu/docker_el6/containerd/namespaces"
	"github.com/neo-hu/docker_el6/containerd/containers"
	"github.com/neo-hu/docker_el6/containerd/diff"
	"github.com/neo-hu/docker_el6/containerd/content"
	"github.com/neo-hu/docker_el6/containerd/dialer"
	...
	"github.com/neo-hu/docker_el6/docker/libcontainerd/containerd/remotes"
	"github.com/neo-hu/docker_el6/docker/libcontainerd/containerd/remotes/docker"
	"github.com/neo-hu/docker_el6/docker/libcontainerd/containerd/remotes/docker/schema1"

	"github.com/neo-hu/docker_el6/containerd/snapshots"
	"github.com/neo-hu/docker_el6/typeurl"
