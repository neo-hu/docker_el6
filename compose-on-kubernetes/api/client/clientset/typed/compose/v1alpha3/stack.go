...
import (
	scheme "github.com/neo-hu/docker_el6/compose-on-kubernetes/api/client/clientset/scheme"
	v1alpha3 "github.com/neo-hu/docker_el6/compose-on-kubernetes/api/compose/v1alpha3"
