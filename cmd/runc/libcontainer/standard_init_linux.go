...
import (
	...
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/apparmor"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/configs"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/keys"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/seccomp"
...
func (l *linuxStandardInit) Init() error {
	...
	label.Init()
	if l.fifo != "" {
		l.config.Config.Mounts = append(l.config.Config.Mounts, &configs.Mount{
			Destination: "/exec.fifo",
			Source:      l.fifo,
			Device: "bind",
	...
	var fd int
	if l.fifo != "" {
		fd, err = unix.Open("/exec.fifo", unix.O_WRONLY|unix.O_CLOEXEC, 0)
	} else {
