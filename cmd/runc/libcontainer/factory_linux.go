...
import (
	...
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/cgroups"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/cgroups/fs"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/cgroups/systemd"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/configs"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/configs/validate"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/intelrdt"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/mount"
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/utils"
...
func (l *LinuxFactory) Create(id string, config *configs.Config) (Container, error) {
	...
	if _, err := os.Stat(containerRoot); err == nil {
		return nil, newGenericError(fmt.Errorf("container with id exists: %v", containerRoot), IdInUse)
...
func (l *LinuxFactory) StartInitialization() (err error) {
	var (
		...
		fifo      = os.Getenv("_LIBCONTAINER_FIFO")
	...
	i, err := newContainerInit(it, pipe, consoleSocket, fifofd, fifo)
	if err != nil {
		return err
	}
