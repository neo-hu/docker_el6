...
func TestParsePackageName(t *testing.T) {
	var (
		name             = "github.com/neo-hu/docker_el6/cmd/runc/libcontainer/stacktrace.captureFunc"
		expectedPackage  = "github.com/neo-hu/docker_el6/cmd/runc/libcontainer/stacktrace"
