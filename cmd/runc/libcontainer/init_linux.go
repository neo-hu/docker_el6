...
import (
	...
	"github.com/neo-hu/docker_el6/containerd/console"
	...
	"github.com/neo-hu/docker_el6/cmd/runc/libcontainer/user"
...
func newContainerInit(t initType, pipe *os.File, consoleSocket *os.File, fifoFd int, fifo string) (initer, error) {
