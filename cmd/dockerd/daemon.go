...
import (
	...
	"github.com/neo-hu/docker_el6/distribution/uuid"
	"github.com/neo-hu/docker_el6/docker/api"
	apiserver "github.com/neo-hu/docker_el6/docker/api/server"
	buildbackend "github.com/neo-hu/docker_el6/docker/api/server/backend/build"
	"github.com/neo-hu/docker_el6/docker/api/server/middleware"
	"github.com/neo-hu/docker_el6/docker/api/server/router"
	"github.com/neo-hu/docker_el6/docker/api/server/router/build"
	checkpointrouter "github.com/neo-hu/docker_el6/docker/api/server/router/checkpoint"
	"github.com/neo-hu/docker_el6/docker/api/server/router/container"
	distributionrouter "github.com/neo-hu/docker_el6/docker/api/server/router/distribution"
	"github.com/neo-hu/docker_el6/docker/api/server/router/image"
	"github.com/neo-hu/docker_el6/docker/api/server/router/network"
	pluginrouter "github.com/neo-hu/docker_el6/docker/api/server/router/plugin"
	sessionrouter "github.com/neo-hu/docker_el6/docker/api/server/router/session"
	swarmrouter "github.com/neo-hu/docker_el6/docker/api/server/router/swarm"
	systemrouter "github.com/neo-hu/docker_el6/docker/api/server/router/system"
	"github.com/neo-hu/docker_el6/docker/api/server/router/volume"
	"github.com/neo-hu/docker_el6/docker/builder/dockerfile"
	"github.com/neo-hu/docker_el6/docker/builder/fscache"
	"github.com/neo-hu/docker_el6/docker/cli/debug"
	"github.com/neo-hu/docker_el6/docker/daemon"
	"github.com/neo-hu/docker_el6/docker/daemon/cluster"
	"github.com/neo-hu/docker_el6/docker/daemon/config"
	"github.com/neo-hu/docker_el6/docker/daemon/listeners"
	"github.com/neo-hu/docker_el6/docker/dockerversion"
	"github.com/neo-hu/docker_el6/docker/libcontainerd"
	dopts "github.com/neo-hu/docker_el6/docker/opts"
	"github.com/neo-hu/docker_el6/docker/pkg/authorization"
	"github.com/neo-hu/docker_el6/docker/pkg/jsonmessage"
	"github.com/neo-hu/docker_el6/docker/pkg/pidfile"
	"github.com/neo-hu/docker_el6/docker/pkg/plugingetter"
	"github.com/neo-hu/docker_el6/docker/pkg/signal"
	"github.com/neo-hu/docker_el6/docker/pkg/system"
	"github.com/neo-hu/docker_el6/docker/plugin"
	"github.com/neo-hu/docker_el6/docker/registry"
	"github.com/neo-hu/docker_el6/docker/runconfig"
	"github.com/neo-hu/docker_el6/go-connections/tlsconfig"
	swarmapi "github.com/neo-hu/docker_el6/docker/swarmkit/api"
